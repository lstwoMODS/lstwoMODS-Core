...
public class DragFloat4 : BaseUIElement<DragFloat4>
{
    ...
    {
        get { var d = (DragFloat4Data)Data; return new Vector4(d.X, d.Y, d.Z, d.W); }
        set { var d = (DragFloat4Data)Data; d.X = value.x; d.Y = value.y; d.Z = value.z; d.W = value.w; MarkChanged(); }
    }

    public DragFloat4(string name, Vector4 value = default, float speed = 1f, float min = 0f, float max = 0f,
