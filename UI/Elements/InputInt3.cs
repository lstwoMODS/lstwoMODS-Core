...
public class InputInt3 : BaseUIElement<InputInt3>
{
    ...
    {
        get { var d = (InputInt3Data)Data; return new Vec3Int(d.X, d.Y, d.Z); }
        set { var d = (InputInt3Data)Data; d.X = value.x; d.Y = value.y; d.Z = value.z; MarkChanged(); }
    }

    public InputInt3(string name, Vec3Int value = default,
                     Action<Vec3Int> onValueChanged = null,
    ...
    public InputInt3 WithValue(Ref<Vec3Int> binding)
    {
