...
public class PlotAnnotation : BaseUIElement<PlotAnnotation>
{
    ...
    public PlotAnnotation WithColor(Col color) { var d = (PlotAnnotationData)Data; d.ColorR = color.r; d.ColorG = color.g; d.ColorB = color.b; d.ColorA = color.a; return this; }
