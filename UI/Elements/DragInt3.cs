...
public class DragInt3 : BaseUIElement<DragInt3>
{
    ...
    {
        get { var d = (DragInt3Data)Data; return new Vec3Int(d.X, d.Y, d.Z); }
        set { var d = (DragInt3Data)Data; d.X = value.x; d.Y = value.y; d.Z = value.z; MarkChanged(); }
    }

    public DragInt3(string name, Vec3Int value = default, float speed = 1f, int min = 0, int max = 0,
    ...
    public DragInt3 WithValue(Ref<Vec3Int> binding)
    {
