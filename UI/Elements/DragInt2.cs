...
public class DragInt2 : BaseUIElement<DragInt2>
{
    ...
    {
        get { var d = (DragInt2Data)Data; return new Vec2Int(d.X, d.Y); }
        set { var d = (DragInt2Data)Data; d.X = value.x; d.Y = value.y; MarkChanged(); }
    }

    public DragInt2(string name, Vec2Int value = default, float speed = 1f, int min = 0, int max = 0,
    ...
    public DragInt2 WithValue(Ref<Vec2Int> binding)
    {
