...
{
    public class DropdownKeybinder : Keybinder
    {
        ...
        {
            var keybind = new DropdownKeybind(this);
            keybinds.Add(keybind);
            return keybind;
        }

        public class DropdownKeybind : Keybind
        {
            public DropdownKeybind(Keybinder keybinder) : base(keybinder)
            {
            ...
            {
                var dropdownKeybinder = keybinder as DropdownKeybinder;

                if (dropdownKeybinder != null)
                {
                    dropdownKeybinder.dropdown.value = keybindValue;
                }
            }
